...
const VARIANT_CLASSES = {
  ...
  style_4 :'text-white w-fit text-[10px] sm:text-xs bg-nice-red px-1.5 py-0.5 rounded-2xl',
  style_5 :'text-foreground/80 w-fit text-xs sm:text-base pt-0.5 rounded-2xl font-bold'
} as const;
